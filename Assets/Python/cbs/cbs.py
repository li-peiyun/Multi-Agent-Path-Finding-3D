...
def main():
    ...
    cbs_dir = os.path.dirname(current_path)

    parser = argparse.ArgumentParser()
    parser.add_argument("param", nargs='?', default=os.path.join(cbs_dir, "input.yaml"), help="input file containing map and obstacles")
    parser.add_argument("output", nargs='?', default=os.path.join(cbs_dir, "output.yaml"), help="output file with the schedule")
